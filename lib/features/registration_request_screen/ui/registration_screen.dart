...
class RegistrationRequest extends StatelessWidget {
  const RegistrationRequest({super.key, required this.simvol, required this.textEditingController});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Image.asset(AppImages.vm),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 20, top: 15),
              child: Container(
            ...
            Padding(
              ...
              child: Text(
                '150 сом',
                style: AppFonts.w400s18.copyWith(color: AppColors.red),
              ),
            ),
            const LinearContainer(),
            Padding(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 40, top: 5),
              child: Text(
                'Произвести оплату можно через платежные \nтерминалы: МТС, Terem Pay, Quickpay, О!\nДеньги, Balance.kg, QIWI, Кыргыз Почтасы, \nЭлсом, Optima Bank, Optima24, UMAI, MegaPay',
                style: AppFonts.w100s14.copyWith(color: Colors.black),
              ),
            ),
            Padding(
